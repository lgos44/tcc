...
Nesse contexto, insere-se esse trabalho. Utilizando a configuração do manipulador mostrada na figura \ref{fig:tetis2}, alternativa àquela abordada em \cite{xaud2016doris},  busca-se:
\begin{itemize}
