...
A matriz $\bm{K}$ da equação \eqref{eq:camera_projection} obtida através da calibração é:
...
Observando que o referêncial da câmera e do efetuador são dados pela figura \ref{fig:camera_ref}, podemos chegar a seguinte 
